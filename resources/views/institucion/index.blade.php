            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container">
                    ...
                    <div style="text-align: center">
                        <table class="min-w-full" style="width: 100%" id="instituciones">
                                    ...
                                    <tr class="border-b" style="width: 100%">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"
                                            ...
                                            <button type="button"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#eliminar{{ $instituto->id }}">
                                                <i class="fa-solid fa-trash-can"></i> {{ __('Delete') }}
                                            </button>
                                            <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
                                                id="eliminar{{ $instituto->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog relative w-auto pointer-events-none">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <form method="POST"
                                                                action={{ route('instituciones.destroy', ['institucione' => $instituto->id]) }}>
                                                                @csrf
                                                                {{ method_field('DELETE') }}
                                                                <button type="submit"
                                                                    class="px-6
                                            ...
                                            {{-- Modal de editar --}}
                                            <a href={{ route('instituciones.edit', ['institucione' => $instituto->id]) }}>
                                                <button type="button"
                                                    class="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
